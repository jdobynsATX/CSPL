...
object Test extends Bdsl {
  ...
  def main(args: Array[String]): Unit = {
    ...
    UPDATE ALL EMPLOYEE WHERE RANK LESSTHANEQUAL 3 WHERE PAY EQUAL 0.0 MODIFY PAY TO 10;

    CREATE NEW EMPLOYEE WITH NAME AS "12lul";
    CREATE NEW INVENTORY WITH NAME AS "item2" WITH COUNT AS 12 WITH TOTAL_COST AS 323.3;
