...
object Test extends Bdsl {
  ...
  def main(args: Array[String]): Unit = {
    ...
    CREATE NEW MEETING WITH NAME AS "Chalupa Extravaganza" WITH CLIENT_ID AS "testing";
    ...
    ASSIGN EMPLOYEE "Bob Jones" TO EVENT PROJECT 1;
    ASSIGN EMPLOYEE "Bill Smith" TO EVENT PROJECT "Hogwarts Partay";
    BATCH ALL EMPLOYEE REMOVE;
    BATCH ALL CLIENT REMOVE;
    BATCH ALL MEETING REMOVE;
    BATCH ALL PROJECT REMOVE;
