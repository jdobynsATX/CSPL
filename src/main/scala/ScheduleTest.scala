...
object ScheduleTest extends Bdsl {
  ...
  def main(args: Array[String]): Unit = {
    ...
    CREATE NEW MEETING WITH NAME AS "Meeting with CEO2" WITH DURATION AS 60; // MEETING ID: 2
    ...
    // CREATE NEW MEETING WITH NAME AS "Staff Dev Meeting"; // MEETING ID: 4
    // BATCH ALL EMPLOYEE WHERE RANK EQUAL 3 ASSIGN TO MEETING 4;

    // CREATE NEW MEETING WITH NAME AS "Software Scrum" WITH START AS "12/06/2016 08:30 PM" WITH DURATION AS 30; // MEETING ID: 5
    // BATCH ALL EMPLOYEE WHERE RANK LESSTHANEQUAL 2 ASSIGN TO MEETING 5;

    // CREATE NEW MEETING WITH NAME AS "Software Scrum" WITH START AS "12/08/2016 08:30 PM" WITH DURATION AS 30; // MEETING ID: 6
