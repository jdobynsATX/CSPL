...
object ScheduleTest extends Bdsl {
  ...
  def main(args: Array[String]): Unit = {
    ...
    CREATE NEW MEETING WITH NAME AS "Meeting with CEO"; // MEETING ID: 1
    ASSIGN EMPLOYEE 1 TO EVENT MEETING 1;
    ASSIGN EMPLOYEE 3 TO EVENT MEETING 1;

    CREATE NEW MEETING WITH NAME AS "Company Party" WITH START AS "12/09/2016 03:30 PM" WITH END AS "12/05/2016 05:00 PM"; // MEETING ID: 2
