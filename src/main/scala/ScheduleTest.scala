...
object ScheduleTest extends Bdsl {
  ...
  def main(args: Array[String]): Unit = {
    ...
    CREATE NEW MEETING WITH NAME AS "Client Project Meeting" WITH DURATION AS 60; // MEETING ID: 7
    BATCH ALL EMPLOYEE WHERE RANK EQUAL 3 ASSIGN EVENT MEETING 7;

    CREATE NEW MEETING WITH NAME AS "Meeting with Client" WITH DURATION AS 60 WITH START AS "12/07/2016 10:00 AM" // MEETING ID: 8
    BATCH ALL EMPLOYEE WHERE RANK EQUAL 2 ASSIGN EVENT MEETING 8;
